...
const Example = () => {
    ...
    const [editedUsers, setEditedUsers] = useState<Record<string, Stock> | Record<string, Order>>({});
    const [data, setData] = useState<Stock[] | Order[]>([]);
    ...
    //CREATE action
    const handleCreateUser: MRT_TableOptions<Stock>['onCreatingRowSave'] | MRT_TableOptions<Order>['onCreatingRowSave'] = async ({
        values,
        exitCreatingMode,
    }) => {
    ...
    //DELETE action
    const openDeleteConfirmModal = (row: MRT_Row<Stock> | MRT_Row<Order>) =>
        modals.openConfirmModal({
            title: 'Are you sure you want to delete this user?',
            children: (
                <Text>
                    Are you sure you want to delete {row.original.id}{' '}
    ...
    const columns = useMemo<MRT_ColumnDef<Stock>[] | MRT_ColumnDef<Order>[]>(
        () => [
            {
                accessorKey: 'id',
                header: 'Id',
...
function validateUser(user: Stock | Order) {
    //return {
